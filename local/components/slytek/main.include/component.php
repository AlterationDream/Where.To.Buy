...
if(!CModule::includeModule('slytek.core'))return;
/************************************************************************************************************/
...
if($arParams['AREA_FILE_SHOW']=='prop' && $arParams['PROPERTY_ID'] && CModule::includeModule('slytek.core')){
	$arResult['CONTENT']=\Slytek\Settings::get(htmlspecialchars_decode($arParams['PROPERTY_ID']), $arParams['SITE_ID']);
}
elseif (!$bHasPath)
{
