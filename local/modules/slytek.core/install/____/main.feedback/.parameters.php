...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"), "EMAIL" => "E-mail", "PHONE" => GetMessage("MFP_PHONE"), "CITY" => GetMessage("MFP_CITY"), "SUBJECT" => GetMessage("MFP_SUBJECT"), "MESSAGE" => GetMessage("MFP_MESSAGE")),
			"DEFAULT"=>"", 
			"COLS"=>25, 
			"PARENT" => "BASE",
		),
