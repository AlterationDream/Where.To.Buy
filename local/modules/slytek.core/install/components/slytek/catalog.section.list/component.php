...
if($arParams['FILTER_NAME'] && is_array($GLOBALS[$arParams['FILTER_NAME']])){
		$arFilter=array_merge($arFilter, $GLOBALS[$arParams['FILTER_NAME']]);
	}
if($this->startResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()).serialize($arFilter)))
{
