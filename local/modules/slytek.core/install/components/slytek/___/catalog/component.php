...
if($arParams["SEF_MODE"] == "Y")
{
	...
	if (\Bitrix\Main\Loader::includeModule('iblock'))
	{
		...
		$engine->addGreedyPart("#DETAIL_URL#");
		$engine->addGreedyPart("#PARTS_SECTION_CODE_PATH#");
		$engine->addGreedyPart("#MODELS_SECTION_CODE_PATH#");
		$engine->setResolveCallback(array("CIBlockFindToolsAtv", "resolveComponentEngine"));
	}
